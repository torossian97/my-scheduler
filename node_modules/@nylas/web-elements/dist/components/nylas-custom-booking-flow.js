...
const NylasCustomBookingFlow$1 = proxyCustomElement(class NylasCustomBookingFlow extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
], NylasCustomBookingFlow$1.prototype, "render", null);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["nylas-custom-booking-flow", "chevron-icon", "info-icon", "search-icon", "select-dropdown", "tooltip-component"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-custom-booking-flow":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasCustomBookingFlow$1);
            }
            break;
        case "chevron-icon":
            if (!customElements.get(tagName)) {
...
const NylasCustomBookingFlow = NylasCustomBookingFlow$1;
const defineCustomElement = defineCustomElement$1;

export { NylasCustomBookingFlow, defineCustomElement };
