...
const NylasBookingForm = proxyCustomElement(class NylasBookingForm extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasBookingFormCss; }
...
function defineCustomElement() {
    ...
    const components = ["nylas-booking-form", "loading-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-booking-form":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasBookingForm);
            }
            break;
        case "loading-icon":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=nylas-booking-form2.js.map