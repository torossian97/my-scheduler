...
import { k as addMinutesToCurrentTime, a as debug } from './utils.js';
...
function defineCustomElement() {
    ...
    const components = ["nylas-booked-event-card", "calendar-check-icon", "checkmark-circle-icon", "globe-icon"];
