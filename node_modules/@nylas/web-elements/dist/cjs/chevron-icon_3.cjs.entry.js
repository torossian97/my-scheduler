...
const ChevronIcon = class {
    ...
    render() {
        return (index.h("svg", { key: '4237d5be45ec5b20c76f6132347abbbff3db30d3', xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none" }, index.h("path", { key: '3d68979af03e88ecb6725fefbd1a4d9af22aa727', fill: "currentColor", d: "M15.53 4.22a.75.75 0 0 1 0 1.06L8.81 12l6.72 6.72a.75.75 0 1 1-1.06 1.06l-7.25-7.25a.75.75 0 0 1 0-1.06l7.25-7.25a.75.75 0 0 1 1.06 0Z" })));
    }
};
...
const SelectDropdown = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.selectedOptionChanged = index.createEvent(this, "selectedOptionChanged", 7);
        this.name = undefined;
        this.options = [];
    ...
    render() {
        return (index.h("div", { key: '4b92f2c224e4cb1ec751c8dd46ff5bd16883110a', class: "dropdown", part: "sd_dropdown" }, index.h("button", { key: 'de1f96fe628dc11b3b7991f65065ec1ae55372fa', part: "sd_dropdown-button", class: { dropbtn: true, open: this.isOpen }, onClick: () => this.toggleDropdown(), "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-label": this.name, onKeyDown: e => this.handleSelectButtonKeyDown(e) }, index.h("slot", { key: '05166ff83a6f0cbf3a63d79e257570c996c2972d', name: "select-icon", "aria-hidden": "true" }), index.h("span", { key: '99d79f6d8969fa6e88092af65ed7438d06c70693', class: "selected-option", part: "sd_dropdown-button-selected-label" }, this.selectedOption?.label ? `${this.selectedOption?.label + this.pluralizedLabel}` : ''), index.h("span", { key: '220bed22a19b8e73a0b5f420a95169b5593138a3', class: {
                open: this.isOpen,
                closed: !this.isOpen,
                chevron: true,
            }, "aria-hidden": "true" }, index.h("chevron-icon", { key: '6ed5947377584f0adaa466c5f2c189e4795e72e2', width: "16", height: "16" }))), this.isOpen ? (index.h("div", { class: "dropdown-content", part: "sd_dropdown-content" }, this.withSearch && (index.h("div", { class: { 'search-box': true, 'open': this.isOpen } }, index.h("search-icon", { width: "15", height: "15", class: 'icon' }), index.h("input", { type: "text", role: "combobox", placeholder: "Search", value: this.searchValue, ref: el => (this.inputRef = el), onInput: event => this.filterOptions(event), onKeyDown: e => this.handleComboboxKeyDown(e) }))), index.h("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-activedescendant": this.ariaActivedescendant, onKeyDown: e => this.handleListboxKeydown(e) }, this.filteredOptions.map(option => (index.h("li", { tabindex: "0", key: option.value, id: option.value, onClick: () => this.selectOption(option), role: "option" }, option.labelHTML ? option.labelHTML : option.label)))))) : null));
    }
