...
const schedulerStore = require('./scheduler-store-33e204ef.js');
...
const genericError = { title: 'Something went wrong...', type: index_es.nr.Error, category: schedulerStore.ErrorCategory.Component };
const NylasScheduling = class {
    ...
    render() {
        ...
        if (showDefaultScheduler && (!eventInfo || !!rescheduleBookingId) && !showBookingForm) {
            ...
            return (index.h(index.Host, null, index.h(SchedulerView, { nylasBranding: nylasBranding, isLoading: this.isLoading, showNotification: this.showNotification }, rescheduleBookingId && index.h(MessageBanner, null, "Choose another time slot to reschedule your meeting"), index.h("div", { class: "select-date-page", part: "select-date-page" }, index.h("div", { class: "left-panel" }, index.h("nylas-date-picker", { exportparts: "ndp, ndp__month-header, ndp__month-button, ndp__day, ndp__date, ndp__date--selected, ndp__date--current-day, ndp__date--current-month" }), index.h("div", { class: "border" }), index.h("nylas-locale-switch", null)), index.h("div", { class: "right-panel" }, index.h("h2", null, index.h("calendar-icon", null), index.h("span", { id: "selectedDate" }, this.selectedDateLabel)), index.h("nylas-timeslot-picker", { exportparts: "ntp, ntp__timeslot, ntp__timeslot--selected, ntp__button-primary" }, timeslotPickerCTALabel && (index.h("span", { slot: "timeslot-picker-cta-label" }, index.h("slot", { name: "timeslot-picker-cta-label" })))))))));
        }
        if (showDefaultScheduler && !eventInfo && showBookingForm) {
            ...
            return (index.h(index.Host, null, index.h(SchedulerView, { nylasBranding: nylasBranding, isLoading: this.isLoading, showNotification: this.showNotification }, rescheduleBookingId && index.h(MessageBanner, null, "Choose another time slot to reschedule your meeting"), index.h("div", { class: "additional-data-page", part: "additional-data-page" }, index.h("div", { class: "left-panel" }, index.h("div", { class: "wrapper" }, index.h("nylas-selected-event-card", { exportparts: "nsec, nsec__card, nsec__icon, nsec__date, nsec__time" }))), index.h("div", { class: "right-panel" }, index.h("nylas-booking-form", { exportparts: "nbf, nbf__input-label, nbf__input-textfield, nbf__button-ghost, nbf__button-primary, nbf__button-outline" }, customTemplateSlot && (index.h("div", { slot: "custom-booking-form" }, index.h("slot", { name: "custom-booking-form" })))))))));
        }
