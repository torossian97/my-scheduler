...
const NylasComposer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8d7f9c145099757c2a8dc48f1d2a223831f82cda' }, index.h("sp-theme", { key: 'e92e457e86701838f55d97b3f2c1c0f70f14bf59', scale: "medium", color: "dark" }, index.h("div", { key: '50eba2b6ee0c84d8eeb392385872604b74b11025', class: "editor", contentEditable: true, ref: r => (this.editorEl = r) }, index.h("div", { key: '38bdd2ec58e62699e2c604b1b2c586cb5ecf105a', class: "toolbar", ref: r => (this.toolbarEl = r), contentEditable: false }, index.h("sp-button", { key: '6415e5f9910a2d9798e7c85162329f359e500aeb', quiet: true, onClick: () => document.execCommand('bold') }, index.h("div", { key: 'e03cfe0f5736836f64aa350165fa519508e212f7', slot: "icon" }, index.h("bold-icon", { key: '1ad03230cff2f0843d6da22153716c3818ed04f7' })), index.h("div", { key: 'd90c50aff88b9ac7774d6792b91ea3ced21f4419', slot: "label" }, "Bold")), index.h("sp-button", { key: '466621fcdf2e8e1e85b613bba82b948ed2177a88', quiet: true, onClick: () => document.execCommand('underline') }, index.h("div", { key: '6be0737cf685b02f3ee8ef7c34fd18674793af00', slot: "icon" }, index.h("underline-icon", { key: '278b1b79d3aec25ab2c2181c3e5c631063b04e29' })), index.h("div", { key: '169d3039815082e208eb476b4490181f7eb54ee6', slot: "label" }, "Underline")), index.h("sp-button", { key: '92c20b2d03b709f08c63af3a1e88b10e407243d7', quiet: true, onClick: () => document.execCommand('italic') }, index.h("div", { key: '67eb3d5b5a2118d90bfb81c7b51d52c41b5ab2a2', slot: "icon" }, index.h("italic-icon", { key: '35ac96f9ff3f3f0c38c7e486092f42dc9451eb63' })), index.h("div", { key: 'f29fe84363cca6e178a3651a1c8e56929ebb3e32', slot: "label" }, "Italic")))), index.h("div", { key: '3d89b191642ab291fc338ffd66be16fe999950b1', class: 'buttons' }, index.h("sp-button", { key: 'f78c122acf4c69c788d411d2dcfd49649c99919e', onClick: this.sendComposer, class: "send" }, "Send"), index.h("sp-button", { key: 'b46873c911cb796e9af22eb7d19bf6e1cd2cd1be', onClick: this.closeComposer, class: "close" }, "Close")))));
    }
...
const NylasSummarizeMessageButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '09d693158ce9480c000957afe31566d47f6fb5f2' }, index.h("sp-theme", { key: '21f246783a3d5786c1cee8f438e89947ee5f574d', scale: "medium", color: "dark" }, index.h("sp-button", { key: '7ef9c60895da162d3b521ddc7c070ff463e51094', label: "Summarize email", "icon-only": true, onClickCapture: this.onClick, class: {
                'summarize-button': true,
                'stopped': this.state === 'stopped',
                'loading': this.state === 'loading',
                'playing': this.state === 'playing',
            } }, this.state === 'stopped' && index.h("play-icon", null), this.state === 'loading' && index.h("loading-icon", null), this.state === 'playing' && index.h("stop-icon", null)), index.h("audio", { key: '7481ceeb62b6eb21c627d0e04be0e0e7a9e986ec', ref: r => (this.audioRef = r), autoPlay: true, onPlaying: () => (this.state = 'playing'), onPause: () => (this.state = 'stopped'), onEnded: () => {
                this.state = 'stopped';
...
const ReplyIcon = class {
    ...
    render() {
        return (index.h("svg", { key: '07034b975afd3fa950dec8be4e28c16775b5a49e', fill: "auto", width: this.width, height: this.height, viewBox: "0 0 1920 1920", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '5601b12fa1dde6412985fa2f701eeb3f9e2b07b4', d: "M835.942 632.563H244.966l478.08-478.08-90.496-90.496L-.026 696.563 632.55 1329.14l90.496-90.496-478.08-478.08h590.976c504.448 0 914.816 410.368 914.816 914.816v109.184h128V1675.38c0-574.976-467.84-1042.816-1042.816-1042.816", "fill-rule": "evenodd" })));
    }
};
