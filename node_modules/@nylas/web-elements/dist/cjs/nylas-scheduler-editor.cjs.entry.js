...
const nylasApiRequest = require('./nylas-api-request-de316f1a.js');
const utils = require('./utils-85bd0909.js');
const schedulerConfigStore = require('./scheduler-config-store-a5b7c08b.js');
 ...
 */
Buffer.TYPED_ARRAY_SUPPORT = index_es.global.TYPED_ARRAY_SUPPORT !== undefined
  ? index_es.global.TYPED_ARRAY_SUPPORT
  : true;
...
const LoginRequired = ({ authenticationUrl }) => (index.h("div", { class: 'login-required' },
...
const NylasSchedulerEditor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9e7d484239633ec60552c6a400fbcda85f2d9ab2' }, index.h("div", { key: '6a360964ca93641b4f62750e95c75d81c8d62daa', class: "scheduler-editor-header", part: "nse__header" }, index.h("h1", { key: 'bdae7fcf66ce0a82d1596b6465d3317226ecc9de', class: "scheduler-editor-title", part: "nse__title" }, index.h("calendar-icon", { key: '2cc5546c75928257239a2fb4aadd0db480a5cd83', width: "18", height: "18" }), "Scheduler editor"), index.h("button", { key: '5429863bb4cb904ad6194db4a425320eab010dab', class: "scheduler-editor-close", onClick: e => this.handleSchedulerConfigCloseClicked(e), part: "nse__close-button" }, index.h("close-icon", { key: '8db91364286cb2be1c9f6b608f27f2def59664e6', width: "18", height: "18" }))), this.stores?.schedulerConfig?.state.currentUser && this.stores.schedulerConfig.state.action === null && (index.h("div", { class: "list-configurations" }, index.h("nylas-list-configurations", null))), this.stores?.schedulerConfig?.state.currentUser && this.stores.schedulerConfig.state.action === 'create' && (index.h("nylas-editor-tabs", { mode: "composable" }, index.h("nylas-event-info", null, index.h("div", { slot: "inputs" }, index.h("nylas-event-title", null), index.h("nylas-event-duration", null), index.h("nylas-location-component", null))), index.h("nylas-booking-calendar-picker", null))), this.stores?.schedulerConfig?.state.currentUser && this.stores.schedulerConfig.state.action === 'edit' && (index.h("nylas-editor-tabs", { mode: this.mode }, this.mode === 'composable' && index.h("slot", null))), !this.stores?.schedulerConfig?.state.currentUser && (index.h("slot", { name: "login-required" }, index.h(LoginRequired, { authenticationUrl: this.authenticationUrl })))));
    }
