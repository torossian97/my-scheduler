...
);pointer-events:var(--mod-illustrated-message-description-pointer-events);position:var(--mod-illustrated-message-description-position);z-index:var(--mod-illustrated-message-description-z-index)}
`;
